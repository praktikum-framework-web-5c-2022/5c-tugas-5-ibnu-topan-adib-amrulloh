...
@section('isi')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="my-5">Masukkan data Karyawan</h2>
            ...
            <form action="{{ route('karyawans.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class=" mb-3">
                    ...
                    <input type="text" name="gajih_lembur" id="gajih_lembur" placeholder="Masukkan gajih_lembur"
                        class="form-control" value="{{ old('gajih_lembur') }}">
                    @error('gajih_lembur')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class=" mb-3">
                    ...
                    <input type="text" name="tunjangan" id="tunjangan" placeholder="Masukkan tunjangan"
                        class="form-control" value="{{ old('tunjangan') }}">
                    @error('tunjangan')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class=" mb-3">
                    ...
                    <input type="text" name="potongan" id="potongan" placeholder="Masukkan potongan"
                        class="form-control" value="{{ old('potongan') }}">
                    @error('potongan')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class=" mb-3">
                    ...
                    <input type="text" name="total_gajih" id="total_gajih" placeholder="Masukkan total_gajih"
                        class="form-control" value="{{ old('total_gajih') }}">
                    @error('total_gajih')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
